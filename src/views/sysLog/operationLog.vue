<template>
  <div class="app-container">
    <div class="search-bar-box">
      ...
      <el-button type="primary"  icon="el-icon-search" size="mini" class="ml-20 el-button-primary" @click="search">查询</el-button>
    </div>
    <div class="tab-container">
      <div class="table-data" style="height: 82%;">
      <el-table ref="tables" :data="tableData" stripe height="98%" style="width: 100%" v-loading="loading" :header-cell-style="{ background: '#f1f6ff', 'text-align': 'center' }" :cell-style="{ align: 'center' }" :tooltip-effect="'light'">
