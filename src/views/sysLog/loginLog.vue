<template>
  <div class="app-container">
    <div class="search-bar-box">
      <span>操作人</span>
      <el-cascader size="mini" class="wh-200" ref="cascader" :options="deptOptions" clearable :props="defaultProps" :emitPath="false" v-model="listQuery.fkUserId" filterable></el-cascader>
      <span class="m-left">类型</span>
      ...
      <span class="m-left">操作日期</span>
      <el-date-picker value-format="yyyy-MM-dd" size="mini" class="wh-200" v-model="listQuery.beginTime" type="date" placeholder="选择日期"></el-date-picker>
      <span>起</span>
      <el-date-picker value-format="yyyy-MM-dd" :picker-options="pickerOptionsEnd" size="mini" class="wh-200" v-model="listQuery.endTime" type="date" placeholder="选择日期"></el-date-picker>
      <span>止</span>
      <!-- <span class="m-left">日志内容</span>
    ...
    <div class="tab-container">
      ...
      <el-table :tooltip-effect="'light'" ref="tables" :data="tableData" stripe height="95%" style="width: 100%" v-loading="loading" :header-cell-style="{ background: '#f1f6ff', 'text-align': 'center' }" :cell-style="{ align: 'center' }">
        ...
        <el-table-column align="center" prop="userName" label="操作人" min-width="80"> </el-table-column>
        <el-table-column align="center" prop="mobile" label="手机号码" min-width="80"></el-table-column>
        <el-table-column align="center" prop="deptName" label="所属部门" min-width="100"></el-table-column>
        <el-table-column align="center" prop="roleName" label="岗位" min-width="100"></el-table-column>
        <el-table-column align="center" prop="ipAddress" label="IP地址" min-width="90"></el-table-column>
        ...
        <el-table-column align="center" prop="operateTime" label="操作时间" min-width="80"></el-table-column>
        <el-table-column align="center" prop="logType" label="类型" min-width="80">
          <template slot-scope="{ row }">
        ...
        <!-- <el-table-column align="center" prop="title" label="操作内容" min-width="80"></el-table-column> -->
        <!-- <el-table-column v-if="user.orgType==0" align="center" prop="operateParam" label="操作数据" min-width="160" show-overflow-tooltip></el-table-column> -->
...
export default {
  ...
  methods: {
    // 查询公司下所有的部门以及部门下的员工
    getAllDeptAndStaff() {
      this.$api.getAllDeptAndStaff({ orgId: this.user.fkOrgId }).then(res => {
        if (res.code == 200) {
