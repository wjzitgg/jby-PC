        ...
        <el-container>
          ...
          <div class="bpmns">
            <div class="flow-chart-box h700">
              ...
              <div class="flow-char-item" v-for="(item, index) in formData.taskFinishVoList" :key="index">
                <div class="char-item-left" :class="{ 'char-item-pass': item.approveStatus == 2, 'char-item-nopass': item.approveStatus == 1 }">
                  ...
                  <div v-if="index != formData.taskFinishVoList.length - 1" class="down-arrow">
                  ...
                  <el-row :span="24" style="width:100%">
                    <el-col :span="6">
                      <div class="dialog-header-item">
                        ...
                        <div class="value">{{formData.settleStatusStr}}</div>
                      </div>
                    </el-col>
                    <el-col :span="6">
                      <div class="dialog-header-item">
  ...
  watch: {
    ...
    dialogVisible2(val) {
      if (val) {
        ...
        this.getData.taskFinishVoList.forEach((item, index) => {
          if (item.approveStatus == 1 || item.approveStatus == 3) {
            this.approveSum = index
          }
        })
        this.accessoryList = this.getData.prodReProcessFileList ? this.getData.prodReProcessFileList : [];
        this.tableDTOS = this.getData.tableDTOS ? JSON.parse(JSON.stringify(this.getData.tableDTOS)) : [];
