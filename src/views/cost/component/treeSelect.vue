<template>
  <div style="position: relative;">
    ...
    <div class="treeBox" v-show="showTree">
      ...
      <el-tree :data="treeList" :check-strictly="true" @node-expand="nodeExpand" @check="checkChange" default-expand-all :show-checkbox="showCheckbox" :props="defaultProps" :expand-on-click-node="false" ref="tree" :node-key="nodeKey" :filter-node-method="filterNode" v-if="showCheckbox">
        <div slot-scope="{ node }" :title="node.label" class="tree-items">
          {{ node.label }}
        </div>
      </el-tree>
      <el-tree :data="treeList" :check-strictly="true" @node-expand="nodeExpand" @check="checkChange" default-expand-all :show-checkbox="showCheckbox" :props="defaultProps" :expand-on-click-node="false" ref="tree" :node-key="nodeKey" :filter-node-method="filterNode" @node-click="nodeClick" v-else>
        <div slot-scope="{ node }" :title="node.label" class="tree-items">
          {{ node.label }}
        </div>
      </el-tree>
