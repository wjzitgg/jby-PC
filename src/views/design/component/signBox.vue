<template>
  <div @mouseup="firstMove(1, $event)" style="position: absolute; text-align: center;background: #f3f3f3;width:80px;height:80px;cursor:move" v-drag="isDrag" ref="signBox">
