<template>
  <div>
    <search-bar  @search="searchData" :options="searchOptions" :total="total" labelWidth="8em" ref="searchBar" :showHandler="false"></search-bar>
    <div class="tab-container">
      <div class="table-data" style="height:95%;margin-top:10px">
      <el-table :data="tableData" ref="tables" stripe height="92%" v-loading="loading" :header-cell-style="{ background: '#f1f6ff' }">
