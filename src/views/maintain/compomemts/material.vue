    ...
    <div class="search-bgc search-mr">
      <el-form :model="listQuery" class="form-data">
        ...
        <el-form-item label="规则名称" label-width="90px">
          <el-input v-model="listQuery.bookName" size="mini" class="wh-100"></el-input>
        </el-form-item>
        <el-button size="mini" type="primary" class="seek ml-20" @click="search">搜索</el-button>
        <el-button type="primary" v-has="'maintain:customData:add'" class="btn-right" size="mini" @click="addUnit">上传</el-button>
      </el-form>
    </div>

    <div class="tab-container">
      <el-table :tooltip-effect="'light'" ref="tables" :data="tableData" border style="width: 100%" v-loading="loading" height="68%" :header-cell-style="{ background: '#f1f6ff' }" :cell-style="{ align: 'center' }">
        ...
        <el-table-column align="center" prop="alarmLevel" label="操作" fixed="right" min-width="320">
          <template slot-scope="scope">
            <el-button size="mini"  type="primary" @click.native="preview(scope.row)">预览</el-button>
            <el-button size="mini" v-has="'maintain:customData:update'" @click.native="edit(scope.row)">编辑</el-button>
            <el-button type="success" size="mini"  @click.native="download(scope.row)">下载</el-button>
            <el-button type="danger" size="mini" v-has="'maintain:customData:delete'" @click.native="remove(scope.row)">删除</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog :title="addTitle" :visible.sync="show1" v-dialogDrag :close-on-click-modal="false" :close-on-press-escape="false" v-loading="loading">
      <el-form :model="form" ref="form" :rules="rules" style="margin-top: 20px">
        <el-form-item label="工程大类" prop="fkEnginerringTypeId" :label-width="formLabelWidth">
          <el-select style="width: 100%" placeholder="请选择" v-model="form.fkEnginerringTypeId" disabled>
        ...
        <el-form-item label="专业类别" prop="fkProfessionalTypeId" :label-width="formLabelWidth">
          <el-select style="width: 100%" placeholder="请选择" v-model="form.fkProfessionalTypeId">
        ...
        <el-form-item label="资料类型" prop="bookType" :label-width="formLabelWidth">
          <el-select style="width: 100%" placeholder="请选择" v-model="form.bookType">
            <el-option label="技术规范" value="0"> </el-option>
            <el-option label="安全规范" value="1"> </el-option>
            <el-option label="验收标准" value="2"> </el-option>
          </el-select>
        ...
        <el-form-item label="备注" prop="remark" :label-width="formLabelWidth">
          <el-input v-model="form.remark" type="textarea" style="resize: none" :rows="3" maxlength="100" placeholder="请输入内容" autocomplete="off"></el-input>
        </el-form-item>
