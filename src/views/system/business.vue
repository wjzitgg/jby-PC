<template>
  <div class="app-container">
    ...
    <div class="tab-container">
      <el-table :data="tableData" border ref="multipleTable" height="70%" style="width: 100%" v-loading="loading" :header-cell-style="{ background: '#f1f6ff', 'text-align': 'center' }" :cell-style="{ align: 'center' }">
        ...
        <el-table-column align="center" prop="enginerringTypeName" label="工程大类" min-width="80"></el-table-column>
        <el-table-column align="center" prop="orgTypeName" label="类型" min-width="90"></el-table-column>
        <el-table-column align="center" prop="orgScaleName" label="公司规模" min-width="80"></el-table-column>
        <el-table-column align="center" prop="createTime" label="系统注册时间" min-width="100"></el-table-column>
        <el-table-column align="center" prop="expireTime" label="有效期" min-width="80"></el-table-column>
        ...
        <el-table-column align="center" prop="telephone" label="管理员手机号码" min-width="100"></el-table-column>
