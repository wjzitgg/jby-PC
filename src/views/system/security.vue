<template>
  <div class="app-container">
    ...
    <el-button type="primary" size="mini" class="search-mr el-button-primary" @click="addUnit"
      v-has="'system:security:add'">上传安全规范</el-button>
    <div class="tab-container">
      <div class="table-data" style="height:82%;margin-top: 10px;">
        <el-table ref="tables" height="95%" :data="tableData" stripe  style="width: 100%" v-loading="loading" :tooltip-effect="'light'"
          ...
          <el-table-column align="center" prop="bookName" label="安全规范" min-width="180"></el-table-column>
          ...
          <el-table-column align="center" prop="alarmLevel" label="操作" fixed="right" min-width="320">
            <template slot-scope="scope">
              <el-button size="mini" type="primary" plain v-has="'system:security:query'"
                @click.native="preview(scope.row)">预览</el-button>
              <el-button size="mini" type="success" plain  v-has="'system:security:edit'" @click.native="edit(scope.row)">编辑</el-button>
              <el-button type="success" plain size="mini" v-has="'system:security:download'"
                @click.native="download(scope.row)">下载</el-button>
              <el-button type="danger" plain size="mini" v-has="'system:security:delete'"
    ...
    <el-dialog :title="addTitle" width="500px" :visible.sync="show1" v-dialogDrag :close-on-click-modal="false" @close="close1"
      ...
      <el-form :model="form" ref="form" :rules="rules" class="dialog-form">
        ...
        <el-form-item label="安全规范" prop="bookName" :label-width="formLabelWidth">
