          ...
          <el-main style="position: relative;">
            <el-tabs v-model="activeName1">
              <el-tab-pane label="处理信息" name="first">
                <!-- 头部信息 -->
                <div class="dialog-header" v-if="!nodeStart">
                ...
                <div class="dialog-header" v-if="nodeStart">
                  <el-row :span="24" class="el-row-data dialog-forms">
                        <el-col :span="8" class="dialog-form-item">
                          ...
                          <div class="content">
                            <el-input v-model="formData.orderCode" size="mini" disabled> </el-input>
                          </div>
                        </el-col>
                        <el-col :span="8" class="dialog-form-item">
                        ...
                        <el-col :span="8" class="dialog-form-item">
                          ...
                          <div class="content">
                            <el-input v-model="formData.serviceTime" size="mini" disabled> </el-input>
                          </div>
                        </el-col>
                        <el-col :span="8" class="dialog-form-item">
                          <div class="labels">填表人</div>
                          <div class="content">
                            <el-input v-model="formData.createUserName" size="mini" disabled> </el-input>
                          </div>
                        </el-col>
                        <el-col :span="8" class="dialog-form-item">
                          <div class="labels">录入时间</div>
                          <div class="content">
                            <el-input v-model="formData.createTime" size="mini" disabled> </el-input>
                          </div>
                        </el-col>
                        <el-col :span="8" class="dialog-form-item">
                          <div class="labels">单据状态</div>
                          <div class="content">
                            <el-input v-model="formData.inventoryCodeName" size="mini" disabled> </el-input>
                          </div>
                        </el-col>
                        <el-col :span="24" class="dialog-form-item">
                          <div class="labels">备注</div>
                          <div class="content">
                            <el-input :value="formData.remark" size="mini" disabled></el-input>
                          </div>
                        </el-col>
                      </el-row>
                </div>
                <div>
                  ...
                  <el-tabs v-model="activeName2" :key="cardRandomKey">
                    <el-tab-pane label="盘点物料" name="1" v-if="nodeStart">
                        <div class="table-data table1">
                          <el-table :tooltip-effect="'light'" style="width: 100%" height="100%" :data="formData.engMatOrderInventoryDetailsVos" stripe :header-cell-style="{ background: '#f1f6ff' }">
