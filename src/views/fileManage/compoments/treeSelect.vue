<template>
  <div style="position: relative;">
    <div @click="changeTreeShow" style="position: relative;">
      <el-input class="input" size="mini" :disabled="disabled" :value="proIds[defaultProps.label]" clearable @clear="clearable">
    ...
    <div class="treeBox" v-show="showTree">
      ...
      <el-tree :data="treeList"  @node-expand="nodeExpand" :check-strictly="true" @check="checkChange" default-expand-all :show-checkbox="showCheckbox" :props="defaultProps" :expand-on-click-node="false" ref="tree" :node-key="nodeKey" :filter-node-method="filterNode" v-if="showCheckbox">
...
export default {
  ...
  methods: {
    ...
    checkChange(data, checked) {
      ...
      // console.log(data);
      this.showTree = false;
      console.log(data, this.proIds, this.$refs.tree.getCheckedKeys());
