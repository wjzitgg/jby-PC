<template>
  <div class="app-container">
    <custom @choose="choose" style="height: 93%;" :types="'1'" v-show="!basicStatus"></custom>
    ...
    <basics v-show="basicStatus" :basicStatus="basicStatus" :id="data.pkId" :orgType="data.orgType"></basics>
    <el-dialog title="选择企业" width="70%" :visible.sync="choiceShow" v-dialogDrag :close-on-click-modal="false" :close-on-press-escape="false" v-loading="loading">
      <div style="height: 560px;">
        <custom @choose="choose" style="height: 85%;" ref="custom" :types="'1'" :status="choiceShow"></custom>
      </div>
    </el-dialog>
  </div>
</template>
