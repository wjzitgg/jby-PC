    ...
    <div class="search-bgc search-mr">
      <el-form :model="listQuery" class="form-data">
        ...
        <el-form-item label="规范名称" label-width="90px">
          <el-input v-model="listQuery.bookName" size="mini" class="wh-150" maxlength="50"></el-input>
        </el-form-item>
        <el-button size="mini" type="primary" icon="el-icon-search" class="seek ml-20" @click="search">搜索</el-button>
        <el-button type="primary" v-has="'userdefined:data:add'" class="btn-right" size="mini" @click="addUnit">上传</el-button>
      </el-form>
    </div>

    <div class="tab-container">
      <div class="table-data" style="height:91%;margin-top: 10px;">
      <el-table :tooltip-effect="'light'" ref="tables" :data="tableData" stripe style="width: 100%" v-loading="loading" height="90%" :header-cell-style="{ background: '#f1f6ff' }" :cell-style="{ align: 'center' }">
        ...
        <el-table-column align="center" prop="alarmLevel" label="操作" fixed="right" min-width="320">
          <template slot-scope="scope">
            <el-button plain size="mini" type="primary" v-has="'userdefined:data:query'" @click.native="preview(scope.row)">预览</el-button>
            <el-button plain size="mini" v-has="'userdefined:data:update'" @click.native="edit(scope.row)">编辑</el-button>
            <el-button plain type="success" size="mini" v-has="'userdefined:data:download'" @click.native="download(scope.row)">下载</el-button>
            <el-button plain type="danger" size="mini" v-has="'userdefined:data:delete'" @click.native="remove(scope.row)">删除</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog :title="addTitle" :visible.sync="show1" v-dialogDrag :close-on-click-modal="false" :close-on-press-escape="false" v-loading="loading">
      <el-form :model="form" ref="form" :rules="rules"  class="dialog-form">
        ...
        <el-form-item label="规范名称" prop="bookName" :label-width="formLabelWidth">
          <el-input v-model="form.bookName" autocomplete="off" maxlength="50"></el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button size="mini" type="primary" @click="submit('form')">保  存</el-button>
      </div>
    </el-dialog>
