<template>
  <div class="app-container">
    ...
    <!-- 表单 -->
    <el-table border :data="showList" ref="tables" height="70%" v-if="typeShow" :row-class-name="tableRowClassName" :header-cell-style="{ background: '#f3f3f3' }" v-loading="loading2">
