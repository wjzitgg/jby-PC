  ...
  <div>
    ...
    <el-dialog :close-on-press-escape="false" title="节点审批" :visible="nodeDialog" @close="closeNodeDialog" width="75%" center v-dialogDrag :close-on-click-modal="false" v-loading="loading">
      <div class="dialog-form">
        ...
        <!-- <el-row :span="24">
          <el-col :span="24" class="mb6">
            <div class="head-flow" v-if="show">
              <span>流程名称</span>
              <el-input size="mini" disabled v-model="data.processName"></el-input>
            </div>
          </el-col>
          <el-col :span="8" class="mb6">
            <div class="head-flow">
              <span>单位工程</span>
              <el-input size="mini" disabled :value="data.reItemApproveDtoList ? data.reItemApproveDtoList[0].unitItemName : ''"></el-input>
            </div>
          </el-col>
          <el-col :span="8" class="mb6">
            <div class="head-flow">
              <span>分部工程</span>
              <el-input size="mini" disabled :value="data.reItemApproveDtoList ? data.reItemApproveDtoList[0].partItemName : ''"></el-input>
            </div>
          </el-col>
          <el-col :span="8" class="mb6">
            <div class="head-flow">
              <span>分项工程</span>
              <el-input size="mini" disabled :value="data.reItemApproveDtoList ? data.reItemApproveDtoList[0].itemName : ''"></el-input>
            </div>
          </el-col>
          <el-col :span="6" class="mb6" v-if="data.itemType == 2">
            <div class="head-flow">
              <span>本次进尺</span>
              <el-input size="mini" disabled v-model="data.distanceSurface"></el-input>
            </div>
          </el-col>
          <el-col :span="6" class="mb6" v-if="data.itemType == 1">
            <div class="head-flow">
              <span>本次填高</span>
              <el-input size="mini" disabled :value="data.currentFillHeight"></el-input>
            </div>
          </el-col>
          <el-col :span="6" class="mb6">
            <div class="head-flow">
              <span>当前节点</span>
              <el-input size="mini" disabled v-model="data.nodeName"></el-input>
            </div>
          </el-col>
          <el-col :span="6" class="mb6">
            <div class="head-flow">
              <span>负责岗位</span>
              <el-input size="mini" disabled v-model="data.roleName"></el-input>
            </div>
          </el-col>
          <el-col :span="6" class="mb6">
            <div class="head-flow">
              <span>负责人</span>
              <el-input size="mini" disabled :value="data.approver"></el-input>
            </div>
          </el-col>
        </el-row> -->
        <ul class="aside">
          <li class="aside-li wh100">
          ...
          <li class="aside-li wh25">
            ...
            <div class="aside-div-right">
              <el-tooltip effect="dark" :content="data.reItemApproveDtoList ? data.reItemApproveDtoList[0].unitProject : ''" placement="bottom-start">
                <span>{{ data.reItemApproveDtoList ? data.reItemApproveDtoList[0].unitProject : "" }}</span>
              </el-tooltip>
            </div>
          </li>
          <li class="aside-li wh25">
            ...
            <div class="aside-div-right">
              <el-tooltip effect="dark" :content="data.reItemApproveDtoList ? data.reItemApproveDtoList[0].partProject : ''" placement="bottom-start">
                <span>{{ data.reItemApproveDtoList ? data.reItemApproveDtoList[0].partProject : "" }}</span>
              </el-tooltip>
            </div>
          </li>
          <li class="aside-li wh25">
            ...
            <div class="aside-div-right">
              <el-tooltip effect="dark" :content="data.reItemApproveDtoList ? data.reItemApproveDtoList[0].outProject : ''" placement="bottom-start">
                <span>{{ data.reItemApproveDtoList ? data.reItemApproveDtoList[0].outProject : "" }}</span>
              </el-tooltip>
            </div>
          </li>
          <li class="aside-li wh25" v-if="data.itemType == 1">
            <div class="aside-div-left">本次填高</div>
            <div class="aside-div-right">{{ data.currentFillHeight }}米</div>
          </li>
          <li class="aside-li wh25" v-if="data.itemType == 2">
            <div class="aside-div-left">本次施工进尺</div>
            <div class="aside-div-right">{{ data.distanceSurface }}米</div>
          </li>
          <li class="aside-li wh25">
            <div class="aside-div-left">当前节点</div>
            <div class="aside-div-right">
              <span>{{ data.nodeName }}</span>
            </div>
          </li>
          <li class="aside-li wh25">
            <div class="aside-div-left">负责岗位</div>
            <div class="aside-div-right">
              {{ data.roleName }}
            </div>
          </li>
          <li class="aside-li wh25">
            <div class="aside-div-left">负责人</div>
            <div class="aside-div-right">
              {{ data.approver }}
            </div>
          </li>
        ...
        <!-- <el-form :inline="true">
          <el-form-item label="分项工程">
            <el-input size="mini" disabled v-model="data.itemNames"></el-input>
          </el-form-item>
          <el-form-item label="本次填高" v-if="data.itemType == 1">
            <el-input size="mini" disabled v-model="(data.fillHeight - data.distanceSurface).toFixed(2)"></el-input>
          </el-form-item>
          <el-form-item label="剩余填高" v-if="data.itemType == 1">
            <el-input size="mini" disabled v-model="data.distanceSurface"></el-input>
          </el-form-item>
          <el-form-item label="本次施工进尺" v-if="data.itemType == 2">
            <el-input size="mini" disabled v-model="data.distanceSurface"></el-input>
          </el-form-item>
          <el-form-item label="施工后剩余进尺" v-if="data.itemType == 2">
            <el-input size="mini" disabled v-model="data.fillHeight - data.distanceSurface"></el-input>
          </el-form-item>
        ...
        <div class="tabelsInfo">
          ...
          <div class="tabelsInfo-main" style="position: relative" v-if="(data.workflowTableList && data.workflowTableList.length) || data.quantitiesTable || data.materialUsedTable">
            <el-tabs v-model="activeName" type="card">
              <el-tab-pane :label="item.tableName" :name="`first${index}`" v-for="(item, index) in data.workflowTableList" :key="item.pkId">
                <div class="tab-box" @scroll="handleScroll">
                  <div class="text-html">
                    <table style="border-collapse: collapse; overflow: auto; margin: 0 auto" ref="printPage" v-if="tableStatus">
                      <tr v-for="(item, idx) in item.tableHtml" :key="idx" style="" v-show="item.status">
                        <td style="box-sizing: content-box; border: none; margin: 0; padding: 0" :contentEditable="i.attributeTypes == 1 && i.disabled == true && i.checkout == false && show && (i.id == '' || i.id == data.currentNodeId || i.name == '') && data.workflowTableList[index].editFlag == 1" @blur="tdBlur(item, id, $event.target.innerText, $event, i)" v-for="(i, id) in item.arr" :style="[i.style]" :key="id" :rowspan="i.row" :colspan="i.span">
                          <span v-if="i.attributeTypes == 1 && i.checkout == false">{{ i.name }}</span>
                          <el-input v-if="i.attributeTypes == 1 && i.checkout == 1" :disabled="i.id != '' && i.id == data.currentNodeId && i.name != ''" @input="tdNameChange(item, id, i.name)" @blur="tdNameBlur(item, id, i.name)" v-model="i.name" size="mini"></el-input>
                          ...
                          <el-select ref="scroll" v-if="i.attributeTypes == 2" size="mini" :disabled="i.id != '' && i.id == data.currentNodeId && i.name != ''" v-model="i.name" placeholder="请选择">
              ...
              <el-tab-pane label="工程量" name="third" v-if="data.quantitiesTable && data.quantitiesTable != 0">
                <div class="tables table-data">
                  <el-table height="100%" stripe :header-cell-style="{ background: '#f1f6ff' }" :data="data.prodItemList">
                    ...
                    <el-table-column align="center" label="每延米工程量" prop="unitQuantity">
                      <template slot-scope="{ row }">
                    ...
                    <el-table-column align="center" label="本次完成工程量" prop="completeQuantities">
                      <template slot-scope="{ row }">
                        ...
                        <span v-if="row.grade != 4">{{ row.completeQuantities }}</span>
                      </template>
                    </el-table-column>
              ...
              <el-tab-pane label="材料用量" name="fourth" v-if="data.materialUsedTable && data.materialUsedTable != 0">
                <div class="tables table-data">
                  <el-table height="100%" stripe :header-cell-style="{ background: '#f1f6ff' }" :data="data.materialItemList">
                    ...
                    <el-table-column align="center" label="实际使用量" prop="actualUsage">
                      <template slot-scope="{ row }">
                        <el-input size="mini" type="text" v-if="row.grade == 4" :disabled="data.materialUsedTable == 1" class="cent" v-model.trim="row.actualUsage" @input="inputFin($event, row, 2)"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column align="center" label="备注">
                      <template slot-scope="{ row }">
                        <el-input size="mini" v-if="row.grade == 4" :disabled="disabled || data.materialUsedTable == 1" v-model="row.materialRemark" class="cent"></el-input>
                      </template>
                    </el-table-column>
                  </el-table>
                </div>
                ...
                <div class="tables table-data">
                  ...
                  <el-table :data="accessoryList" height="100%" style="width: 100%" stripe :header-cell-style="{ background: '#f1f6ff' }">
                    ...
                    <el-table-column label="附件内容描述" align="center" prop="remark">
                      <template slot-scope="{ row }">
                        <el-input v-if="show" v-model="row.remark" size="mini" :disabled="!row.deleteFlag" maxlength="100"></el-input>
                        <el-tooltip effect="dark" :content="row.remark" placement="top" v-else>
                    ...
                    <el-table-column label="操作" align="center" width="100">
                      <template slot-scope="{ row, $index }">
                        <span class="addAcc" v-if="accessoryList.length == $index + 1 && show" @click="addAcc(row)" title="添加">
                          <i class="el-icon-plus"></i>
                        </span>
                        <span class="delAcc" v-if="row.deleteFlag && show" @click="delAcc(row)" title="删除">
                          <i class="el-icon-close"></i>
                        </span>
                        <el-button size="mini" type="primary" class="downloadAcc" v-if="!show" @click="downloadAcc(row)"> 下载 </el-button>
                      </template>
                    </el-table-column>
              ...
              <el-tab-pane label="审批记录" name="record" v-if="data.approveDetailList && data.approveDetailList != 0">
                <div class="tables table-data">
                  <el-table height="100%" stripe :header-cell-style="{ background: '#f1f6ff' }" :data="data.approveDetailList">
                    <el-table-column align="center" label="流程节点" prop="activityName" />
                    <el-table-column align="center" label="所属工序" prop="processName" />
                    <el-table-column align="center" label="负责人" prop="approver" />
                    <el-table-column align="center" label="操作内容" prop="approveComment" />
                    <el-table-column align="center" label="操作时间" prop="approveTime" />
                    <el-table-column align="center" label="详情">
                      <template slot-scope="{ row }">
                        <el-button size="mini" type="primary" v-if="row.approveStatus!=2" class="previewAcc" @click="nodeDetels(row)"> 查看 </el-button>
                      </template>
                    </el-table-column>
                  </el-table>
                </div>
            ...
            v-if="activeName != 'third' && activeName != 'fourth' && activeName != 'fifth'"
            style="position: absolute;top: 4px;right: 8px;">打印</el-button> -->
            <!-- <div class="print-export">
              <el-button type="primary" size="mini" @click="dataExport">导出</el-button>
              <el-button type="primary" size="mini" @click="dataPrinting">打印</el-button>
            </div> -->
        ...
        <!-- 关联资料 -->
        <div class="linkInfo">
          <div class="linkInfo-main">
            <div class="linkInfo-left">
              <div class="header">关联资料</div>
              <div class="linkInfo-left-main">
                <div class="linkInfo-left-main-item" v-for="(item, index) in data.bookPdfDTOS" :key="index">
                  <i class="iconfont iconpdf"></i>
                  <span>{{ index + 1 }}、{{ item.bookName }} 第{{ item.beginPage == item.endPage ? item.beginPage : `${item.beginPage} ~ ${item.endPage}` }}页</span>
                  <span><el-button size="mini" @click="lookPdf2(item)">查看</el-button></span>
                </div>
              </div>
            </div>
            <div class="linkInfo-middle">
              <div class="header">流程图</div>
              <div class="linkInfo-left-main" @click="bpmnContent(data.hisProcessDiagram)">
                <img src="../../assets/xmlimg.svg" alt="" class="bnpm-img" />
              </div>
            </div>
            <div class="linkInfo-right">
              <div class="header">审批意见</div>
              <div class="linkInfo-left-main">
                <el-input type="textarea" :rows="4" resize="none" placeholder="请输入内容" maxlength="200" :disabled="!show" v-model="textare"> </el-input>
              </div>
            </div>
            <div class="linkInfo-middle" v-if="data.scoreFlag && data.scoreFlag != 0">
              <div class="header">工程评分</div>
              <div class="score-rio">
                <el-radio-group v-model="score" :disabled="!show || data.scoreFlag == 1">
      ...
      <div slot="footer" class="dialog-footer" v-if="show">
        <el-button type="primary" @click="handleApprove" v-if="!siStatus">审批通过</el-button>
        ...
        <el-button type="danger" @click="handleUnApprove" v-if="!!data.refuseBtnStatus">审批不通过</el-button>
        <el-button type="primary" plain @click="closeNodeDialog">取 消</el-button>
      </div>
    ...
    <proCheckDialog :data="nodeData" :proChangeDialog.sync="proChangeDialog" :appDiaType="1" />
    <NodeDialog2 :nodeDialog.sync="disposeDialog" :show="false" :data="nodeData" />
    <!-- :noApprove="auditStatus==2?true:false" -->
    <approveCodeDialog ref="approveCodeDialog" v-if="nodeDialog" :siStatus="siStatus" :signed="signed" @signature="signature" :approveCodeDialog.sync="approveCodeDialog" :sign-date="signDate" @closeLoading="closeLoading" @approveOk="handleFlow" :biz-type="0" :appCodeType="appCodeType"  @getNew="getNew"/>
    <div style="position: absolute; left: -99999999px" v-if="tableStatus">
...
// import proCheckDialog from "../../views/home/compoments/proCheckDialog.vue"
import proCheckDialog from "./proCheckDialog.vue";
import NodeDialog2 from "./NodeDialog2";
export default {
  // computed: {
  //       user() {
    ...
    nodeDialog(val) {
      if (val == false) {
        ...
        if (this.show) {
          ...
          this.score = this.data.checkResult;
          console.log(this.score);
          this.textare = this.comment;
          this.accessoryList = this.data.fileList && this.data.fileList.length ? this.data.fileList.map((item, index) => ({ ...item, id: index + 1 })) : [{ id: 1, fileName: "", remark: "", fileUrl: "", deleteFlag: true }];
        } else {
          this.score = this.data.checkResult;
        ...
        this.pdfTable = [];
        this.pdfTitle = [];
        this.tableList = JSON.parse(JSON.stringify(this.data.workflowTableList));
        // // this.$nextTick(() => {
        ...
        const sysRoleId = this.data.sysRoleId;
  ...
  methods: {
      ...
      if (this.pdfTable.length != 0) {
        this.pdfTable.forEach(item => {
          item.forEach(e => {
            e.arr.forEach(i => {
              if (i.attributeTypes == 3) {
                if (i.signatureDate.signer == this.data.roleId || i.signatureDate.signer == this.data.sysRoleId) {
    ...
    tdBlur(item, id, val, e, i) {
      ...
      if (i.disabled) {
        ...
        // i.id = this.user.pkId;
        i.id = this.data.currentNodeId;
      }
      if (!nokong) {
        i.id = "";
      }
      console.log(i.id);
      console.log(this.data.currentNodeId);
    },
    ...
    handleApprove() {
      ...
      if(this.data.scoreFlag== 1&&!this.score){
        return this.$message.warning("请填写工程评分")
      }
      if (this.data.materialUsedTable === 2) {
        const arr = this.data.materialItemList;
        // const arr2 = arr.filter(item => item.actualUsage != "");
        let materialStatus = 0;
        arr.forEach(item => {
          if (item.actualUsage == null) {
            console.log(item);
            materialStatus = 1;
          }
        });
      ...
      this.$confirm("确定审批?", "审批提醒", {
        ...
        // });
        this.loading = true;
        const res = this.$refs.approveCodeDialog.getApproveStatus();
    ...
    handleUnApprove() {
      ...
      this.$confirm("确定审批?", "审批提醒", {
        ...
        // });
        this.loading = true;
        this.$refs.approveCodeDialog.getApproveStatus(null,true);
      });
    },
    closeLoading() {
      this.loading = false;
    ...
    handleFlow(unique) {
      ...
      if (this.auditStatus === 1) {
        ...
        if (tableData.length > 0) {
          tableData.forEach((item, idx) => {
            ...
            if (this.tableList[idx].tableHtml == item.tableHtml) {
              item.isModified = 0;
            } else {
              item.isModified = 1;
            }
      ...
      if (this.pdfTable.length == 0 || this.auditStatus === 2) {
        ...
        // return console.log(this.data.workflowTableList)
        let num1 = params.workflowTableList.filter(item => item.convertPdfStatus == 1).length;
        let num2 = 0;
        if (num1 > 0) {
          this.pdfTable.forEach((item, idx) => {
    ...
    inputFin(e, row, type) {
      ...
      if (type == 1) {
        ...
        row.actualUsage = this.$limitInputNumber(val, 9999999.999999, 0, 6);
      }
    },
    // 添加附件
    addAcc(row) {
