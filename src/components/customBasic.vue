<template>
  <div class="containers" ref="content">
    ...
    <panel ref="panel" :fkOrgId="fkOrgId" :orgType="orgType" :element="element" :businessObject="businessObject" :moddle="moddle" :forbidden="false" :modeling="modeling" 
    :fkProfessionalTypeId="fkProfessionalTypeId" :fkEnginerringTypeId="fkEnginerringTypeId"  :addTitle="addTitle" :workflowType="workflowType" :tableSource="tableSource"/>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    dataOh() {
      ...
      this.$emit("ensureab", ElementRegistry[0], this.bpmnModeler);
    },
    dataOhsa() {
      const ElementRegistry = this.bpmnModeler.get("elementRegistry").getAll();
