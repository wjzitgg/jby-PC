<template>
  <div style="border: 1px solid #ccc;" v-loading="loading">
    <Toolbar :defaultConfig="toolbarConfig" :editor="editor" :mode="mode" style="border-bottom: 1px solid #ccc" ref="toolbar" />
    <Editor v-model="html" :defaultConfig="editorConfig" :mode="mode" class="editor" @onCreated="onCreated" ref="editor" />
  </div>
</template>
