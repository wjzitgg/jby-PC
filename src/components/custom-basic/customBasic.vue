<template>
  <div class="containers" ref="content">
    ...
    <panel @getReply="getReply" ref="panel" :fkOrgId="fkOrgId" :orgType="orgType" :element="element" :businessObject="businessObject" :moddle="moddle" :forbidden="false" :modeling="modeling" 
    :fkProfessionalTypeId="fkProfessionalTypeId" :fkEnginerringTypeId="fkEnginerringTypeId"  :addTitle="addTitle" :workflowType="workflowType" :tableSource="tableSource" :flowTableArr="flowTableArr"
    :user="user" :warehouseType="warehouseType" @pdfList="pdfList"  @launchInit="launchInit" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    exportDiagram(data, item,arr,row) {
      this.addTitle = item;
      let _this = this;
      ...
      console.log("xxxxxxxxx11111xxxxxxxxxxxxx")
