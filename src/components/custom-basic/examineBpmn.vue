<template>
  <div class="containers" ref="content">
    ...
    <panel
      ...
      :fkProfessionalTypeId="fkProfessionalTypeId" :fkEnginerringTypeId="fkEnginerringTypeId" :workflowType="workflowType" :fkOrgId="fkOrgId" :dataList="dataList" :user="user"
    />
  </div>
</template>
