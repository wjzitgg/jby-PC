  ...
  <div class="panel-tab__content">
    <el-form size="mini" label-width="80px" @submit.native.prevent>
      <el-form-item label="节点类型">
        ...
        <el-radio-group v-model="formKey" clearable @change="updateElementFormKey">
          <el-radio :label="12">普通节点</el-radio>
          <el-radio :label="13">钢架混泥土</el-radio>
          <el-radio :label="14">混泥土搅拌站</el-radio>
        </el-radio-group>
      </el-form-item>
    ...
    <!-- <div class="element-property list-property">
      ...
      <el-table :data="fieldList" size="mini" height="240" border fit>
    ...
    <!-- <template v-if="formFieldForm.type === 'enum'">
        ...
        <el-table :data="fieldEnumList" size="mini" key="enum-table" height="240" border fit>
    ...
    <!-- <el-divider key="validation-divider" />
      ...
      <el-table :data="fieldConstraintsList" size="mini" key="validation-table" height="240" border fit>
        <el-table-column label="序号" width="50px" type="index" />
    ...
    <!-- <el-divider key="property-divider" />
      ...
      <el-table :data="fieldPropertiesList" size="mini" key="property-table" height="240" border fit>
        <el-table-column label="序号" width="50px" type="index" />
